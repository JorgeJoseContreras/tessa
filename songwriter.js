...
try {
    ...
    if(songPromptInput && generateBtn) {
        songPromptInput.placeholder = "Songwriter studio is unavailable at the moment.";
        songPromptInput.disabled = true;
        generateBtn.disabled = true;
        const errorP = document.createElement('p');
        errorP.textContent = "Oops! My creative circuits are down. Please try again later.";
